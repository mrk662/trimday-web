...
export default function JoinPlatform() {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      // 1. REGISTER IN SUPABASE AUTH (Sends email and creates internal user)
      ...
      // Use the ID generated by Supabase Auth for our Shop ID
      ...
      if (shopError) {
        if (shopError.code === '23505') {
          alert("This mobile number or email is already registered. Please log in.");
          setLoading(false);
          return;
        }
        throw shopError;
